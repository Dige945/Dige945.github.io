/* global NexT, CONFIG */
HTMLElement.prototype.wrap=function(e){this.parentNode.insertBefore(e,this),this.parentNode.removeChild(this),e.appendChild(this)},function(){const e=()=>document.dispatchEvent(new Event("page:loaded",{bubbles:!0}));"loading"===document.readyState?document.addEventListener("readystatechange",e,{once:!0}):e(),document.addEventListener("pjax:success",e)}(),NexT.utils={registerExtURL(){document.querySelectorAll("span.exturl").forEach((e=>{const t=document.createElement("a");
...
const i=o.querySelector(".active")||o.firstElementChild,r=parseInt(window.getComputedStyle(i).height,10)||0,c=parseInt(window.getComputedStyle(i).paddingTop,10),a=parseInt(window.getComputedStyle(i.firstElementChild).marginBottom,10);
// Hight might be `auto`.
...
const e=parseInt(window.getComputedStyle(o.querySelector(".active")).height,10);o.style.height=e+c+a+"px"}
